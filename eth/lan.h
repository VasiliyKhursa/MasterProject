...
/* //PC
#define IP_ADDR				inet_addr(192,168,137,22)
#define IP_SUBNET_MASK		inet_addr(255,255,255,0)
#define IP_DEFAULT_GATEWAY	inet_addr(192,168,137,1)
*/

//
#define IP_ADDR				inet_addr(192,168,2,199)
#define IP_SUBNET_MASK		inet_addr(255,255,255,0)
#define IP_DEFAULT_GATEWAY	inet_addr(192,168,2,2)
