...
// 0 - normal mode 						- 	������� �����
// 1 - �-axis symmetry (mirror image) 	- 	��������� �� ��� � (������������ ����� x1y1)
// 2 - y-axis symmetry (mirror image) 	- 	��������� �� ��� Y (������������ ����� x1y1)
// 3 - 180 degree rotation 				- 	�������� �� 180 �������� (������������ ����� x1y1)
// 4 - mirror image, -90 degree   		- 	�������� �� 90 �������� ������ ������� ������� 
//											������������ ������� ���������� (������������ ����� x1y1)
//											� ��������� � ���������� �
// 5 - +90 degree 						- 	�������� �� 90 �������� �� ������� ������� 
//											������������ ������� ���������� (������������ ����� x1y1)
...
// char width, char high - ������ � ������ �������� ���� ��������������
// rot = 1 - ����� �����
// rot = 0 - ����� ������ ������������
// char start_pos_x, char start_pos_y - � ���������(����������) ������ ���������� ��������� �����(������ ����� ����� �������� ����)
