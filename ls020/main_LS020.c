...
SIGNAL(SIG_ADC)
{	
	put_dot(KoordinaY0 + dots ,KoordinaX0 + 70 ,white,16);
char str[3] = "000";
	itoa(ADCH,str,10);
	ls020_rectangle(0,0,70,70,bgColor,8);
//	ls020_rectangle(0,0,175,131,bgColor,8);
	ls020_put_string6x8(53,20,str,fgColor,bgColor , 8);
	...
	put_dot(KoordinaY0 + dots ,KoordinaX0 + 70 ,brown,16);
...
//	InitSPI(0,0,0,0);
	...
	rotationl(30, 30, 14, 8, 0);

	put_char8x14(14, 50, 0x50, 0x91D4, 0xFFFF, 16, 0);
...
/*
//------------------------------------------------------------------------------------------------------
// װאיכû הכÿ פאיכמגמי סטסעולû
//#define F_CPU 14745600UL		//freq 14745600 Hz
#include "main.h"
